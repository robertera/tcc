...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    |Tradução em Portugues Brasileiro para as validações
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'declined_if' => 'O :attribute deve ser recusando quando :other é :value.',
    'different' => 'O :attribute e :other devem ser diferentes.',
    'digits' => 'O :attribute deve ser :digits digitos.',
    'digits_between' => 'O :attribute deve ser entre :min e :max digitos.',
    'dimensions' => 'O :attribute possui dimensoes de imagem invalidas.',
    'distinct' => 'O :attribute campo possui valores duplicados.',
    'doesnt_end_with' => 'O :attribute não deve terminar com um dos seguintes valores: :values.',
    'doesnt_start_with' => 'O :attribute não deve começar com um dos seguintes valores: :values.',
    ...
    'enum' => 'O :attribute seleconado é invalido.',
    'exists' => 'O :attribute slecionado é invalido.',
    'file' => 'O :attribute deve ser um arquivo.',
    'filled' => 'O :attribute campo deve possuir um valor.',
    //PAREI AQUI!!!!!!!!
    'gt' => [
